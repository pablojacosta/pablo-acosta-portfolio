      ...
      <div className="px-6 max-w-7xl mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {filteredProjects.map(project => (
            <article
              key={project.title}
              className="group bg-zinc-900 rounded-lg overflow-hidden border border-white/5 hover:border-orange-500/20 transition-colors"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    ...
                    className="px-4 py-2 bg-orange-500 text-black font-medium rounded hover:bg-orange-600 transition-colors"
                  >
                    View Project
                  </Link>
                  {project.type === 'personal' && project.githubUrl && (
                    <Link
                      ...
                      className="px-4 py-2 bg-background border border-orange-500/20 text-orange-500 font-medium rounded hover:bg-orange-500/10 transition-colors"
                    >
                      View Code
                    </Link>
                  )}
