  ...
  return (
    <main className="px-6 pt-32 pb-24 max-w-4xl mx-auto">
      <div className="space-y-16">
        ...
        {/* Experience Section */}
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-orange-500">Experience</h2>
        ...
        {/* Philosophy Section */}
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-orange-500">Philosophy</h2>
          <p className="text-lg text-gray-300">
        ...
        <div className="space-y-6">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
            <li className="flex items-start gap-3 p-4 rounded-lg bg-orange-800/10 ring-1 ring-orange-500/10">
              <span className="h-1.5 w-2 rounded-full bg-orange-500 mt-2" />
            ...
            <li className="flex items-start gap-3 p-4 rounded-lg bg-orange-800/10 ring-1 ring-orange-500/10">
              <span className="h-1.5 w-4 rounded-full bg-orange-500 mt-2" />
              <span className="text-gray-300">
            ...
            <li className="flex items-start gap-3 p-4 rounded-lg bg-orange-800/10 ring-1 ring-orange-500/10">
              <span className="h-1.5 w-3 rounded-full bg-orange-500 mt-2" />
              <span className="text-gray-300">
